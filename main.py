...
def run_single_test(agent_class, 
    ...
    rl_agents = []
    state_size = 10  # [position_i, position_j, ressources environnantes (8 directions)]
        ...
        for step in range(steps):
            ...
            for idx, rl_agent in enumerate(rl_agents):
                ...
                if agent_to_test == "DQN":
                    ...
                    # mise à jour de l'état courant et action précédente
...
# visualiser un épisode avec la politique apprise
print("\nvisualisation d'un épisode avec la politique apprise:")
visualize_episode(agent_class, env_class, agent_config, env_config, emotion_config, num_episodes_training=30)